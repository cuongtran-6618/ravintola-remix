  ...
  return (
    <section className="">
      ...
      <div className="mobile-block">
        ...
        on a plate that is filled with deep, aromatic flavors and vibrant
        colors. Fresh seafood, vegetables and lava stone grilled meat make up
        for only a small part of the Asian specialities that will melt your
        heart and soul.
      </div>
    </section>
  );
